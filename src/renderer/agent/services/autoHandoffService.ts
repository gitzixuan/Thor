...
async function continueAutoHandoff(result: HandoffSessionResult): Promise<void> {
  ...
  await Agent.send(
    ...
    {
      provider: appState.llmConfig.provider,
      model: appState.llmConfig.model,
      apiKey: appState.llmConfig.apiKey,
      baseUrl: appState.llmConfig.baseUrl,
      timeout: appState.llmConfig.timeout,
      maxTokens: appState.llmConfig.maxTokens,
      temperature: appState.llmConfig.temperature,
      topP: appState.llmConfig.topP,
      enableThinking: appState.llmConfig.enableThinking,
      thinkingBudget: appState.llmConfig.thinkingBudget,
      reasoningEffort: appState.llmConfig.reasoningEffort,
      protocol: appState.llmConfig.protocol,
      headers: appState.llmConfig.headers,
